    ...
    <section className="relative bg-black">
      <div className="relative min-h-[520px] md:min-h-[680px]">
        ...
        <div className="absolute inset-x-0 bottom-0 z-10">
          <div className="grid min-w-0 grid-cols-1 sm:grid-cols-2 xl:flex xl:flex-row">
            {specs.map((spec, index) => (
              <div
                key={`${spec.label}-${index}`}
                className={`min-w-[12rem] px-5 py-4 sm:min-w-0 sm:px-6 md:px-8 md:py-5 lg:px-10 xl:flex-auto ${
              ...
              >
                <p className="font-display text-balance text-[1.75rem] font-semibold leading-tight text-white md:text-[2.2rem] md:leading-tight">
                  {spec.value}
                </p>
