...
import { LayoutDashboard, Star, FileText, Mail, Calendar, UserCheck, Receipt, BookOpen, Shield, Users, Sparkles } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
const navItems = [
  ...
  { icon: Sparkles, label: "May Madness Requests", href: "/admin/may-madness-requests" },
